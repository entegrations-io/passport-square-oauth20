...
please post a question on the [discussion forum](https://github.com/entegrations-io/passport-squaure-oauth20/discuss)
rather than filing an issue.

#### Is this a security issue?

Do not open issues that might have security implications.  Potential security
vulnerabilities should be reported privately to npm@entegrations.io.  Once any
...
* passport-square-oauth20 version: <!-- $ npm list passport-square-oauth20 -->
